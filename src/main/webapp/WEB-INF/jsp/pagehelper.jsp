...
<div style="text-align:center;">
    <ul class="pagination">
        ...
        <c:if test="${!pagehelper.isFirstPage}">
            ...
            <a href="javascript:queryAllPerson(${pagehelper.prePage}, ${pagehelper.pageSize});">上一页</a>
        </c:if>
        ...
        <c:if test="${!pagehelper.isLastPage}">
            ...
            <a href="javascript:queryAllPerson(${pagehelper.lastPage}, ${pagehelper.pageSize});">最后一页</a>
        </c:if>
